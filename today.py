# Terminal/neofetch-style profile generator.
# Based on the open template by Andrew Grant (https://github.com/Andrew6rant/Andrew6rant).
# Adapted for ashw1nkumars.
import datetime
...
if __name__ == '__main__':
    ...
    age_data, age_time = perf_counter(daily_readme, datetime.datetime(2023, 10, 28)) # GitHub join date — change to your birthday if you prefer
